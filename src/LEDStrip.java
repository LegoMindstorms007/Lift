...
public class LEDStrip {
    private static final int SET_MODE = 0x6e;
    private static final int FADE_MODE = 0x63;
    private final SensorPort i2cPort;
